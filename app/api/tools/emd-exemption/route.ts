...
${xmlParagraph(
  `Subject: EMD Exemption Declaration against Bid No. ${data.bidNumber}`,
  {
    bold: true,
    after: 220,
  }
...
${xmlParagraph(
  `We request consideration of exemption from Earnest Money Deposit (EMD) requirements on the basis of: ${data.exemptionBasis}.`,
  {
    after: 180,
  }
)}
...
${xmlParagraph(
  "We understand that the applicability of the claimed exemption is subject to the eligibility requirements, documentary conditions and other provisions specified in the referenced bid / tender.",
  {
    after: 180,
  }
)}
...
${xmlParagraph(
  "We further understand that the buyer / procuring authority may verify the registration, certificate and supporting documents submitted in support of the exemption claim.",
  {
    after: 180,
  }
)}
...
${xmlParagraph(
  "We confirm that the information furnished in this declaration is true and correct to the best of our knowledge and belief and that the supporting documents submitted by us shall correspond with the exemption basis stated above.",
  {
    after: 300,
  }
)}
...
function removePreviousDeclaration(
  ...
  return xml.replace(
    /<!-- BIDAXIS-EMD-EXEMPTION-START -->[\s\S]*?<!-- BIDAXIS-EMD-EXEMPTION-END -->/g,
    ""
  );
}
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: "EMD EXEMPTION DECLARATION",
                bold: true,
                size: 26,
              }),
            ],
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text:
                  `Subject: EMD Exemption Declaration against Bid No. ` +
                  `${data.bidNumber}`,
                bold: true,
                size: 22,
              }),
          ...
          bodyParagraph(
            `We request consideration of exemption from Earnest Money ` +
              `Deposit (EMD) requirements on the basis of: ` +
              `${data.exemptionBasis}.`
          ),
          ...
          bodyParagraph(
            "We understand that the applicability of the claimed " +
              "exemption is subject to the eligibility requirements, " +
              "documentary conditions and other provisions specified " +
              "in the referenced bid / tender."
          ),

          bodyParagraph(
            "We further understand that the buyer / procuring authority " +
              "may verify the registration, certificate and supporting " +
              "documents submitted in support of the exemption claim."
          ),

          bodyParagraph(
            "We confirm that the information furnished in this declaration " +
              "is true and correct to the best of our knowledge and belief " +
              "and that the supporting documents submitted by us shall " +
              "correspond with the exemption basis stated above.",
            280
          ),
  ...
  try {
    ...
    if (!accuracyAccepted) {
      return Response.json(
        {
          error:
            "Please confirm the accuracy of the exemption information before generating the document.",
        },
        {
          status: 400,
        }
    ...
    const data: DeclarationData = {
      ...
      exemptionBasis: get("exemptionBasis"),
    ...
    const filename =
      `EMD-Exemption-Declaration-${cleanFilename(
        data.companyName
      )}.docx`;
    ...
    console.error(
      "EMD Exemption generation error:",
      error
    );
