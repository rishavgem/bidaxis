...
export default function TendersContent() {
  ...
  /*
   * Read initial filters from browser URL.
   *
   * Example:
   * /tenders?keyword=laptop&location=Delhi
   */
  useEffect(() => {
  ...
  /*
   * Load tenders after the URL values have
  ...
  /*
   * Re-sort already loaded tenders
      ...
      <section className="py-16">
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-16 rounded-3xl bg-blue-900 p-10 text-center text-white">
            ...
            <h2 className="text-3xl font-bold">
              Get Personalized Tender
              Alerts
            </h2>

            <p className="mt-4 text-blue-100">
              Login to save tenders and
