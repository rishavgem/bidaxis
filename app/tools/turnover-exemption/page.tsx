...
export default function TurnoverExemptionPage() {
  ...
  async function handleSubmit(
    ...
    if (!accuracyAccepted) {
      setMessage(
        "Please confirm the accuracy of the turnover exemption information."
      );
      setMessageType("error");
      return;
    }
    ...
    try {
      ...
      anchor.href = url;
      anchor.download =
        `Turnover-Exemption-Declaration-${company}.docx`;
      ...
      setMessage(
        "Turnover Exemption Declaration generated successfully."
      );
        ...
        <div className="container">
          ...
          <div className="hero">
            ...
            <div>
              ...
              <h1>
                Turnover Exemption <span>Declaration</span>
              </h1>

              <p>
                Generate a professional turnover exemption declaration
                for GeM and government tender submissions using your
                applicable exemption basis.
              </p>
          ...
          <form className="formCard" onSubmit={handleSubmit}>
            ...
            {mode === "letterhead" && (
              <div className="uploadBox">
                <input
                  id="turnover-letterhead"
                  type="file"
                  accept=".docx,application/vnd.openxmlformats-officedocument.wordprocessingml.document"
                  onChange={handleLetterhead}
                />

                <label htmlFor="turnover-letterhead">
            ...
            <SectionHeader
              ...
              description="Provide the actual basis and supporting registration or certificate details for the turnover exemption claim."
              step="02"
            />
            ...
            <div className="formGrid">
              ...
              <Field
                label="Turnover Exemption Basis"
                name="exemptionBasis"
            ...
            <div className="confirmationBox">
              ...
              <div>
                <strong>Eligibility information confirmation</strong>

                <p>
                  This generator does not independently determine
                  eligibility for turnover exemption. Applicability
                  depends on the relevant tender conditions and the
            ...
            <p className="note">
              Review the applicable turnover criteria and attach the
              required supporting evidence before tender submission.
            </p>
          </form>
          ...
          <aside className="previewColumn">
            <div className="previewCard">
              <div className="previewHeader">
                <div>
                  ...
                  <strong>Turnover Exemption Declaration</strong>
                </div>
              ...
              <div className="paper">
                ...
                <h3>TURNOVER EXEMPTION DECLARATION</h3>
                ...
                <div className="previewText">
                  ...
                  <p>
                    <b>Subject:</b> Turnover Exemption Declaration
                    against Bid No.{" "}
                    <strong>
                  ...
                  <p>
                    ...
                    , request consideration of exemption from the
                    applicable turnover eligibility requirement for
                    the referenced tender.
                  </p>
                  ...
                  <p>
                    Applicability remains subject to the tender
            ...
            <div className="infoCard">
              ...
              <div>
                ...
                <p>
                  The tool does not automatically assume MSME,
                  Startup or any other turnover exemption status.
                </p>
              </div>
            </div>
            ...
            <div className="infoCard">
              ...
              <div>
                ...
                <p>
                  Generate with the BidAxis template or append the
                  declaration to your uploaded Word letterhead.
                </p>
              </div>
            </div>
          </aside>
