...
export default function LandBorderPage() {
  ...
  async function handleSubmit(
    ...
    if (!accuracyAccepted) {
      setMessage(
        "Please confirm the accuracy of the information before generating the declaration."
      );
      setMessageType("error");
      return;
    }
    ...
    try {
      ...
      anchor.href = url;
      anchor.download =
        `Land-Border-Declaration-${company}.docx`;
      ...
      setMessage(
        "Land Border Declaration generated successfully."
      );
        ...
        <div className="container">
          ...
          <div className="hero">
            ...
            <div>
              ...
              <h1>
                Land Border <span>Declaration</span>
              </h1>

              <p>
                Generate an editable declaration concerning applicable
                land-border related bidder eligibility requirements for
                government tender and GeM submissions.
              </p>

              <div className="tags">
                <span>Eligibility Declaration</span>
                <span>Government Tender</span>
        ...
        <div className="container layout">
          <form className="formCard" onSubmit={handleSubmit}>
            <SectionHeader
              ...
              description="Generate with the BidAxis template or append the declaration to your existing Word letterhead."
              step="01"
            />
            ...
            {mode === "letterhead" && (
              <div className="uploadBox">
                <input
                  id="land-border-letterhead"
                  type="file"
                  accept=".docx,application/vnd.openxmlformats-officedocument.wordprocessingml.document"
                  onChange={handleLetterhead}
                />

                <label htmlFor="land-border-letterhead">
            ...
            <SectionHeader
              ...
              title="Enter bidder and tender information"
              description="Select or enter the eligibility / registration status applicable to your company."
              step="02"
            />
            ...
            <div className="formGrid">
              ...
              <div className="full">
                <label className="fieldLabel">
                  Eligibility / Registration Status <em>*</em>
                </label>
                ...
                >
                  ...
                  <option value="The bidder is not required to be registered under the applicable land-border related procurement requirement.">
                    Registration not required / not applicable
                  </option>

                  <option value="The bidder is registered with the competent authority as required under the applicable land-border related procurement requirement.">
                    Registered with competent authority
                  </option>

                  <option value="The bidder confirms compliance with the applicable land-border related eligibility requirements specified in the bid documents.">
                    Compliant as per applicable bid conditions
                  </option>
                </select>

                <p className="helper">
                  Select only the status that accurately applies to your
                  company and the referenced tender.
                </p>
              </div>
            ...
            <div className="confirmationBox">
              ...
              <div>
                <strong>Accuracy & authorization confirmation</strong>

                <p>
                  The selected status is inserted into the declaration
                  exactly as a bidder-provided representation. BidAxis
                  does not independently determine the company&apos;s
                  eligibility or registration requirement.
                </p>
                ...
                <label className="confirm">
                  ...
                  <span>
                    I confirm that the information and eligibility /
                    registration status entered above are accurate, and
                    I am authorized to use them for this declaration.
                  </span>
                </label>
              </div>
            </div>
            ...
            <p className="note">
              Review the tender&apos;s applicable eligibility provisions
              and supporting-document requirements before submission.
            </p>
          </form>
          ...
          <aside className="previewColumn">
            <div className="previewCard">
              <div className="previewHeader">
                <div>
                  ...
                  <strong>Land Border Declaration</strong>
                </div>
              ...
              <div className="paper">
                ...
                <div className="previewText">
                  ...
                  <p>
                    <b>Subject:</b> Declaration regarding applicable
                    land-border related eligibility requirements against
                    Bid No.{" "}
                    <strong>
                  ...
                  <p>
                    ...
                    , submit this declaration in connection with the
                    referenced bid.
                  </p>
                  ...
                  <p>
                    ...
                    {form.registrationStatus ||
                      "Select the applicable eligibility / registration status."}
                  </p>

                  <p>
                    We understand that eligibility remains subject to
                    the applicable procurement provisions, bid
            ...
            <div className="infoCard">
              ...
              <div>
                <strong>Bidder-controlled declaration</strong>

                <p>
                  Eligibility status is selected by the user rather
                  than automatically inferred by the generator.
                </p>
              </div>
            </div>
            ...
            <div className="infoCard">
              ...
              <div>
                <strong>Editable DOCX output</strong>

                <p>
                  The generated Word file remains editable before
                  signature and tender submission.
                </p>
              </div>
            </div>
          </aside>
