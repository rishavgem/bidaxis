...
export default function WarrantyDeclarationPage() {
  ...
  async function handleSubmit(
    ...
    if (!confirmed) {
      setMessage(
        "Please confirm the accuracy of the warranty information before generating the document."
      );
      setMessageType("error");
      return;
    }
    ...
    try {
      ...
      body.append("accuracyAccepted", confirmed ? "true" : "false");
      ...
      const response = await fetch(
        "/api/tools/warranty-declaration",
        {
          method: "POST",
          body,
        }
      ...
      anchor.href = url;
      anchor.download =
        `Warranty-Declaration-${company}.docx`;
      ...
      setMessage(
        "Warranty Declaration generated successfully."
      );
        ...
        <div className="container">
          ...
          <div className="hero">
            ...
            <div>
              ...
              <h1>
                Warranty <span>Declaration</span>
              </h1>

              <p>
                Generate a professional product warranty declaration
                for GeM and government tender submissions.
              </p>
        ...
        <div className="container layout">
          <form className="formCard" onSubmit={handleSubmit}>
            ...
            {mode === "letterhead" && (
              <div className="uploadBox">
                <input
                  id="warranty-letterhead"
                  type="file"
                  accept=".docx,application/vnd.openxmlformats-officedocument.wordprocessingml.document"
                  onChange={handleLetterhead}
                />

                <label htmlFor="warranty-letterhead">
            ...
            <SectionHeader
              ...
              title="Enter product and tender information"
              description="The information entered below will be inserted into the generated declaration."
              step="02"
            />
            ...
            <div className="confirmationBox">
              <div className="confirmationIcon">
                <Icon name="warranty" size={22} />
              </div>

              <div>
                <strong>Warranty information confirmation</strong>

                <p>
                  The generated document will state the warranty period
                  entered above. Confirm that this period and the related
                  product information match your actual offer and the
                  applicable tender requirements.
                </p>
                ...
                <label className="confirm">
                  ...
                  <span>
                    I confirm that the product and warranty information
                    entered above is accurate and may be used to generate
                    this declaration.
                  </span>
                </label>
              </div>
            ...
            <p className="note">
              Review the generated warranty terms against the relevant
              tender, contract and product warranty conditions before
              signing.
            </p>
          </form>
          ...
          <aside className="previewColumn">
            <div className="previewCard">
              <div className="previewHeader">
                <div>
                  ...
                  <strong>Warranty Declaration</strong>
                </div>
              ...
              <div className="paper">
                ...
                <div className="previewText">
                  ...
                  <p>
                    <b>Subject:</b> Warranty Declaration against Bid No.{" "}
                    <strong>
                  ...
                  <p>
                    ...
                    , hereby declare that the offered{" "}
                    <strong>
                      {form.productName || "Product Name"}
                    </strong>{" "}
                    shall be covered by a warranty period of{" "}
                    <strong>
                  ...
                  <p>
                    The warranty obligations shall be fulfilled in
                    accordance with the applicable specifications,
                    scope and contractual conditions of the referenced
                    tender.
                  </p>
                </div>

                <div className="warrantyBadge">
                  <Icon name="warranty" size={18} />

                  <div>
                    <span>DECLARED WARRANTY</span>
                    <strong>
                      {form.warrantyPeriod || "Warranty Period"}
                    </strong>
                  </div>
            ...
            <div className="infoCard">
              ...
              <div>
                <strong>Warranty-specific declaration</strong>

                <p>
                  Product and warranty period are captured separately
                  to avoid inserting assumptions into the document.
                </p>
              </div>
            </div>
