...
export default function LowestPricePage() {
  ...
  async function handleSubmit(
    ...
    if (!accuracyAccepted) {
      setMessage(
        "Please confirm the accuracy of the pricing information before generating the declaration."
      );
      setMessageType("error");
      return;
    }
    ...
    try {
      ...
      anchor.href = url;
      anchor.download =
        `Price-Declaration-${company}.docx`;
      ...
      setMessage(
        "Price Declaration generated successfully."
      );
        ...
        <div className="container">
          ...
          <div className="hero">
            ...
            <div>
              ...
              <h1>
                Lowest Price / <span>Price Declaration</span>
              </h1>

              <p>
                Generate an editable price declaration for a product
                offered against a government tender or GeM bid using
                the bidder-provided price information.
              </p>
        ...
        <div className="container layout">
          <form className="formCard" onSubmit={handleSubmit}>
            <SectionHeader
              ...
              description="Use the BidAxis template or append the declaration to an existing Word letterhead."
              step="01"
            />
            ...
            <div className="modeGrid">
              <ModeCard
                ...
                description="Generate a professional editable Word declaration."
            ...
            {mode === "letterhead" && (
              <div className="uploadBox">
                ...
                <label htmlFor="price-letterhead">
            ...
            <SectionHeader
              ...
              description="These details identify the bidder and the procurement for which the declaration is being generated."
              step="02"
            />
            ...
            <SectionHeader
              label="PRICE DETAILS"
              title="Enter offered product and price"
              description="The generated declaration reproduces the price entered here. Include the applicable currency and pricing basis."
              step="03"
            />

            <div className="pricePanel">
              <div className="priceIcon">
                <Icon name="price" size={24} />
              </div>

              <div>
                <strong>Bidder-provided pricing</strong>
                <p>
                  Example: ₹1,25,000 per unit excluding GST, or
                  ₹1,47,500 per unit including applicable GST.
                </p>
              </div>
            </div>
            ...
            <div className="formGrid">
              <div className="full">
                <Field
                  ...
                  onChange={updateField}
                  placeholder="Product / model / item description"
                  required
                />
              </div>
              ...
              <div className="full">
                <Field
                  ...
                  onChange={updateField}
                  placeholder="₹1,25,000 per unit excluding GST"
                  required
                />
              </div>
            ...
            <div className="confirmationBox">
              ...
              <div>
                ...
                <p>
                  BidAxis inserts the pricing information supplied by
                  the user. The tool does not independently determine
                  whether the entered price is the lowest price in any
                  market, catalogue or other transaction.
                </p>
                ...
                <label className="confirm">
                  ...
                  <span>
                    I confirm that the product and offered price entered
                    above are accurate for the referenced bid and that
                    I am authorized to use this information in the
                    declaration.
                  </span>
                </label>
              </div>
            ...
            <p className="note">
              Review taxes, freight, quantity basis and other
              commercial conditions in the final document and tender
              before submission.
            </p>
          </form>
          ...
          <aside className="previewColumn">
            <div className="previewCard">
              <div className="previewHeader">
                <div>
                  ...
                  <strong>Price Declaration</strong>
                </div>
              ...
              <div className="paper">
                ...
                <div className="pricePreview">
                  ...
                  <b>
                    {form.offeredPrice ||
                      "₹0.00 / applicable basis"}
                  </b>
                </div>

                <div className="previewText">
                  <p>
                    The above price is declared for the
                    referenced bid and remains subject to
                    its applicable commercial conditions.
                  </p>

                  <p>
                    The information furnished in this
                    declaration is confirmed by the bidder
                    as true and correct.
                  </p>
                </div>
            ...
            <div className="infoCard">
              ...
              <div>
                <strong>
                  Clear commercial declaration
                </strong>

                <p>
                  Product and offered-price information is
                  prominently displayed in the generated
                  document.
                </p>
              </div>
            </div>
            ...
            <div className="infoCard">
              ...
              <div>
                ...
                <p>
                  ...
                  before signature and tender submission.
                </p>
              </div>
            </div>
          </aside>
